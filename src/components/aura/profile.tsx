...
export function Profile() {
  ...
  return (
    <div className="fade-in space-y-4 pb-4">
      {/* Founder Tagline Bar - like reference screenshot */}
      {profileIsFounder && (
      ...
      <div className="relative -mt-16 px-4">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            {/* Profile Song Indicator - only shows when a song is actually picked */}
            {(() => {
              ...
              return (
                <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold flex items-center gap-1 profile-song-indicator ${
                  profileIsFounder ? 'bg-amber-500/20 text-amber-300 border border-amber-400/30' : 'bg-violet-500/20 text-violet-300 border border-violet-500/30'
                }`}>
