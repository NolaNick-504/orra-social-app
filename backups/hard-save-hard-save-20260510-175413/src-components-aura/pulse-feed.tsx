  ...
  return (
    <div className="fade-in space-y-4 pb-4">
      ...
      {filteredPosts.map((post) => {
        ...
        return (
          <div key={post.id} id={`post-${post.id}`} className={`glass-panel rounded-2xl overflow-hidden hover:border-violet-500/20 transition-all relative ${echoAnimation === post.id ? 'echo-ripple' : ''}`}>
