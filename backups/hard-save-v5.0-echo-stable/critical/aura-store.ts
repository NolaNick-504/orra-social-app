...
export interface UserSettings {
  ...
  language: string;
  feedRefreshInterval: number; // minutes: 5 (default) or 15
  ...
  persist(
    (set, get) => ({
      ...
      userSettings: {
        ...
        language: 'English',
        feedRefreshInterval: 5, // minutes (5 or 15)
      ...
      openPostDetail: (postId) => set({ showPostDetail: true, selectedPostId: postId }),
      closePostDetail: () => set({ showPostDetail: false, selectedPostId: null }),
