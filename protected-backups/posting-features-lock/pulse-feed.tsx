    ...
    >
      {topStream ? (
        ...
        <div className="relative h-44 md:h-52">
          ...
          <div className="absolute bottom-16 left-3 w-44 z-10 space-y-1.5 pointer-events-none">
            {SIMULATED_CHAT.slice(chatIdx, chatIdx + 3).map((msg, i) => (
              ...
              >
                <span className="text-[10px] font-bold text-violet-300 whitespace-nowrap">{msg.user}</span>
                <span className="text-[10px] text-white/80 truncate">{msg.text}</span>
              </div>
            ))}
          </div>
